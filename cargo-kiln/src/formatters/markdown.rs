//! Markdown output generation for cargo-kiln reports
//!
...
/// Markdown formatter for cargo-kiln reports
#[derive(Clone)]
...
impl MarkdownReportGenerator {
    ...
    pub fn safety_report(
        ...
        if formatter.github_flavor {
            ...
            writeln!(
                output,
                "_Generated by [cargo-kiln](https://github.com/pulseengine/kiln) 🤖_"
            )?;
        }
...
pub fn create_github_pr_comment(
    ...
    output.push_str("---\n");
    output.push_str(
        "_Generated by [cargo-kiln](https://github.com/pulseengine/kiln) safety verification_ 🤖\n",
    );
